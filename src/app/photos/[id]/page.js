    ...
    <div style={{ width: '100vw', padding: '0 4rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', width: '100%', height: '60vh' }}>
        ...
        <AnimatePresence mode='wait'>
          <motion.div
            className="standard-border standard-blur"
            style={{ display: 'flex', flexDirection: 'column', padding: '1.25rem', justifyContent: 'space-between', background: 'rgba(255, 255, 255, .5)', borderRadius: '1rem', width: '25%' }}
